...
/**
 * Methods that are provided by the \@discord-selfbot-sdk/voice library to implementations of
...
export interface DiscordGatewayAdapterImplementerMethods {
	/**
	 * This will be called by \@discord-selfbot-sdk/voice when the adapter can safely be destroyed as it will no
	 * longer be used.
	 */
	destroy(): void;
	/**
