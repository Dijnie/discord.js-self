...
const PacketHandlers = Object.fromEntries([
  ...
  ['CALL_CREATE', require('./CALL_CREATE.js')],
  ['CALL_DELETE', require('./CALL_DELETE.js')],
  ['CALL_UPDATE', require('./CALL_UPDATE.js')],
  ['PASSIVE_UPDATE_V2', require('./PASSIVE_UPDATE_V2.js')],
  ...
  ['SESSIONS_REPLACE', require('./SESSIONS_REPLACE.js')],
  ['TYPING_START', require('./TYPING_START.js')],
  ['USER_CONNECTIONS_UPDATE', require('./USER_CONNECTIONS_UPDATE.js')],
  ['USER_NOTE_UPDATE', require('./USER_NOTE_UPDATE.js')],
  ['USER_UPDATE', require('./USER_UPDATE.js')],
  ['FRIEND_SUGGESTION_CREATE', require('./FRIEND_SUGGESTION_CREATE.js')],
  ['FRIEND_SUGGESTION_DELETE', require('./FRIEND_SUGGESTION_DELETE.js')],
